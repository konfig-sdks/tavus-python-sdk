...
class RequiredVideosCreateVideoFromReplicaAndScriptRequest(TypedDict):
...
class OptionalVideosCreateVideoFromReplicaAndScriptRequest(TypedDict, total=False):
...
class VideosCreateVideoFromReplicaAndScriptRequest(RequiredVideosCreateVideoFromReplicaAndScriptRequest, OptionalVideosCreateVideoFromReplicaAndScriptRequest):
    pass
