...
class RequiredReplicasCreateNewReplicaResponse(TypedDict):
    pass

class OptionalReplicasCreateNewReplicaResponse(TypedDict, total=False):
...
class ReplicasCreateNewReplicaResponse(RequiredReplicasCreateNewReplicaResponse, OptionalReplicasCreateNewReplicaResponse):
    pass
