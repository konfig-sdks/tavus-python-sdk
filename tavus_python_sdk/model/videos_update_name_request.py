...
class VideosUpdateNameRequest(
    ...
    video_name: MetaOapg.properties.video_name
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["video_name", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["video_name"]) -> MetaOapg.properties.video_name: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["video_name", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        video_name: typing.Union[MetaOapg.properties.video_name, str, ],
