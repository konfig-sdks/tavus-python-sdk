...
class VideosGetAllResponse(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['VideosGetAllResponseData']:
                return VideosGetAllResponseData
            __annotations__ = {
                "data": data,
            }
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'VideosGetAllResponseData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['VideosGetAllResponseData', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        data: typing.Union['VideosGetAllResponseData', schemas.Unset] = schemas.unset,
