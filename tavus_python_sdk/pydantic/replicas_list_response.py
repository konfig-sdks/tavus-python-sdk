...
from tavus_python_sdk.pydantic.replicas_list_response_data import ReplicasListResponseData

class ReplicasListResponse(BaseModel):
    data: typing.Optional[ReplicasListResponseData] = Field(None, alias='data')
    class Config:
