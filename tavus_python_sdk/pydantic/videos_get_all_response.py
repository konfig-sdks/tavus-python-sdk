...
from tavus_python_sdk.pydantic.videos_get_all_response_data import VideosGetAllResponseData

class VideosGetAllResponse(BaseModel):
    data: typing.Optional[VideosGetAllResponseData] = Field(None, alias='data')
    class Config:
