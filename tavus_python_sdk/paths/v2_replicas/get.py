...
from tavus_python_sdk.model.replicas_list_response import ReplicasListResponse as ReplicasListResponseSchema

from tavus_python_sdk.type.replicas_list_response import ReplicasListResponse

from ...api_client import Dictionary
from tavus_python_sdk.pydantic.replicas_list_response import ReplicasListResponse as ReplicasListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ReplicasListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ReplicasListResponse
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ReplicasListResponsePydantic:
        raw_response = await self.raw.alist(
            **kwargs,
        )
        if validate:
            return ReplicasListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(ReplicasListResponsePydantic, raw_response.body)
