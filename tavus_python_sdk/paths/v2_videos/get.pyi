...
from tavus_python_sdk.model.videos_get_all_response import VideosGetAllResponse as VideosGetAllResponseSchema

from tavus_python_sdk.type.videos_get_all_response import VideosGetAllResponse

from ...api_client import Dictionary
from tavus_python_sdk.pydantic.videos_get_all_response import VideosGetAllResponse as VideosGetAllResponsePydantic

SchemaFor200ResponseBodyApplicationJson = VideosGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: VideosGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> VideosGetAllResponsePydantic:
        raw_response = await self.raw.aget_all(
            **kwargs,
        )
        if validate:
            return VideosGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(VideosGetAllResponsePydantic, raw_response.body)
