...
class BaseApi(api_client.Api):
    ...
    def _delete_by_video_id_mapped_args(
        self,
        video_id: str,
    ...
    async def _adelete_by_video_id_oapg(
        self,
...
class DeleteByVideoIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_by_video_id(
        self,
        video_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_by_video_id_mapped_args(
            video_id=video_id,
        )
        return await self._adelete_by_video_id_oapg(
    ...
    def delete_by_video_id(
        ...
        return self._delete_by_video_id_oapg(
            path_params=args.path,
        )

class DeleteByVideoId(BaseApi):
    ...
    async def adelete_by_video_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_by_video_id(
            video_id=video_id,
            **kwargs,
        )
    ...
    def delete_by_video_id(
        ...
        raw_response = self.raw.delete_by_video_id(
            video_id=video_id,
        )
